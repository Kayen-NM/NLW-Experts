const perguntas = [
    {
      pergunta: "Qual a finalidade do comando 'console.log()' em JavaScript?",
      respostas: [
    ...
    {
      pergunta: "Qual a função do operador '===' em comparações em JavaScript?",
      respostas: [
